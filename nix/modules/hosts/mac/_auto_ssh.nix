  ...
  launchd.daemons.autossh-saaf-dev = {
    serviceConfig = {
      ...
      ProgramArguments = [
        ...
        "GatewayPorts yes"
        "-L"
        "0.0.0.0:5421:dev-saaf-us-east-1-db-aurora-rds-pg.cluster-cylgsngtg19w.us-east-1.rds.amazonaws.com:5432"
        "ec2-user@dev-saaf-aurora-bh-us-east-1-lb-5289c3247da1e2dc.elb.us-east-1.amazonaws.com"
        "-i"
        "${config.age.secrets.dev_rsa.path}"
      ];
      RunAtLoad = true;
      KeepAlive = true;
  ...
  launchd.daemons.autossh-saaf-ppd = {
    serviceConfig = {
      ...
      ProgramArguments = [
        ...
        "GatewayPorts yes"
        "-L"
        "0.0.0.0:5433:ppd-saaf-us-west-2-db-aurora-rds-pg.cluster-cncae2g4snn0.us-west-2.rds.amazonaws.com:5432"
        "ec2-user@ppd-saaf-aurora-bh-us-west-2-lb-02f29db02e2a726f.elb.us-west-2.amazonaws.com"
        "-i"
        "${config.age.secrets.ppd_rsa.path}"
      ];
      RunAtLoad = true;
      KeepAlive = true;
      EnvironmentVariables = {
