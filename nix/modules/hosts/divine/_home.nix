...
{ config, ... }: {
  home-manager.users.${config.username} =
    ...
    }:
    {
      ...
      # NOTE: noctalia's homeManager module comes via the kde_shell aspect
      # (kde feature) - importing it here too would double-define its options.
      ...
      # Mako is the notification daemon for the niri session only - in Plasma
      # sessions plasmashell (or Noctalia, via the kde_shell aspect) owns
