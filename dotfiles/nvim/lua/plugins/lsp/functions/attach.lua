...
local function on_attach(client, bufnr)
	...
	keyset("n", "gD", vim.lsp.buf.declaration, "Go to Declaration")
	keyset("n", "gi", vim.lsp.buf.implementation, "Go to Implementation")
	keyset("n", "[d", vim.diagnostic.goto_prev, "Previous diagnostic")
	keyset("n", "]d", vim.diagnostic.goto_next, "Next diagnostic")
