return {
	...
	config = function()
		...
		require("diffview").setup({
			...
			icons = { -- Icons used in the diff view
				folder_closed = "",
				folder_open = "",
			},
			signs = {
			...
			view = {
				...
				default = {
					-- Config for changed files, and staged changes
				...
				merge_tool = {
					...
					winbar_info = true, -- Show the conflicted file's path in the winbar
				},
				file_history = {
					-- Config for changed files in file history views
					layout = "diff2_horizontal",
					winbar_info = false, -- Show the file's path in the winbar
				},
			},
			file_panel = {
			...
			keymaps = {
				...
				view = {
					...
					["gf"] = actions.goto_file, -- Open the file in a new split
				...
				file_panel = {
					...
					["f"] = actions.toggle_flatten_dirs, -- Flatten empty subdirectories in tree listing
